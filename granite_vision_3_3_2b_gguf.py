# -*- coding: utf-8 -*-
"""granite-vision-3.3-2b-GGUF.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/#fileId=https%3A//huggingface.co/ibm-granite/granite-vision-3.3-2b-GGUF.ipynb
"""
...
Model page: https://huggingface.co/ibm-granite/granite-vision-3.3-2b-GGUF

⚠️ If the generated code snippets do not work, please open an issue on either the [model repo](https://huggingface.co/ibm-granite/granite-vision-3.3-2b-GGUF)
...
llm = Llama.from_pretrained(
	repo_id="ibm-granite/granite-vision-3.3-2b-GGUF",
	filename="{{GGUF_FILE}}",
)
